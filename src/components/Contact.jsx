...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "57d1e8a8-4773-4bd6-ab20-b0e43c1b2729");
  ...
  return (
    <motion.div
        ...
        <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
